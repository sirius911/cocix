...
\end{enumerate}
%C'est 4 \textit{attributs} sont eux-même des \textit{Objets}.\\
...
\multirow{2}*{$<$ \textit{seuil très malade}\footnotemark[2]} &\\
&  très Malade\\ \hline
0\% &\CoCiX mort !\\ \hline
\end{tabular}
\end{center}
...
\footnotetext[2]{Le \emph{seuil très malade} est un nombre calculé avec le gène ['\textit{seuil\_tres\_malade}'] et la \textbf{.cs} du \CoCiX}
